...
export default function Contact() {
  return (
    <div className="section contact flex row scroll-anchor max-width-block" id="contact">
      <div className="contact-title text-wide-bold">{`Hey, let's connect!`}</div>
      ...
      <div className="contact-title text-wide-bold">{`Social`}</div>
