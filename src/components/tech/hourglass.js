  ...
  const projectDescription = (
    <>
      <p>
        ...
        consultants, lawyers, tutors, freelancers, and contractors) where users can allocate predetermined hours, deduct
        hours as the timer runs, and alerts users when client hours approaches the user's set threshold.
      </p>
  ...
  return (
    <div className="project-container flex column">
      ...
      <div className="project-text-container">
        ...
        <div className="project-about">{projectDescription}</div>
      </div>
